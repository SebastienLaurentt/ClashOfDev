...
const ClickMeCard = () => {
  return (
    <div className="relative h-[600px] rounded-[60px] bg-primary md:h-[650px] lg:h-[820px] xl:h-[650px] 2xl:h-[900px]">
      ...
      <div className="relative mx-auto mt-[125px] flex h-[91px] w-[185px] items-center justify-center md:w-[185px] xl:w-[185px] 2xl:mt-[132px] 2xl:w-[219px]">
        <button
          className="z-20 h-[58px] w-[178px] rounded-[60px] bg-background text-[13.67px] font-semibold md:w-[178px] xl:w-[178px] 2xl:w-[212px]"
