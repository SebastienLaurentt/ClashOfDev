  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <div className="mx-auto mb-[100px] flex w-[366px] flex-col md:w-[720px] md:items-center lg:w-[960px] lg:flex-row lg:justify-between xl:w-[1216px] 2xl:mb-40 2xl:w-[1376px]">
        <div className="mb-10 flex flex-col text-[74px] font-semibold leading-[82px] text-foreground lg:text-[68px] xl:text-[92px] xl:leading-[100px] 2xl:mb-0 2xl:text-[115px] 2xl:leading-[123px]">
